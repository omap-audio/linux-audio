...
static struct omap_clk omap54xx_clks[] = {
	...
	CLK("omap-mcbsp.1",	"pad_fck",		&pad_clks,	CK_54XX),
	CLK("omap-mcbsp.2",	"pad_fck",		&pad_clks,	CK_54XX),
	CLK("omap-mcbsp.3",	"pad_fck",		&pad_clks,	CK_54XX),
