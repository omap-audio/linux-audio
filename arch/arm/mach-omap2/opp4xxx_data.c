 ...
 */
#define OMAP4430_VP_MPU_VLIMITTO_VDDMIN	0xA
#define OMAP4430_VP_MPU_VLIMITTO_VDDMAX	0x39
#define OMAP4430_VP_IVA_VLIMITTO_VDDMIN	0xA
#define OMAP4430_VP_IVA_VLIMITTO_VDDMAX	0x2D
#define OMAP4430_VP_CORE_VLIMITTO_VDDMIN	0xA
#define OMAP4430_VP_CORE_VLIMITTO_VDDMAX	0x28

#define OMAP4430_ON_VOLTAGE_UV				1350000
#define OMAP4430_ONLP_VOLTAGE_UV			1350000
#define OMAP4430_RET_VOLTAGE_UV			837500
#define OMAP4430_OFF_VOLTAGE_UV			600000
...
struct omap_volt_data omap444x_vdd_mpu_volt_data[] = {
...
struct omap_vp_param omap444x_mpu_vp_data = {
	.on_volt		= OMAP4430_ON_VOLTAGE_UV,
	.onlp_volt		= OMAP4430_ONLP_VOLTAGE_UV,
	.ret_volt		= OMAP4430_RET_VOLTAGE_UV,
	.off_volt		= OMAP4430_OFF_VOLTAGE_UV,
	.vp_vddmin		= OMAP4430_VP_MPU_VLIMITTO_VDDMIN,
	.vp_vddmax		= OMAP4430_VP_MPU_VLIMITTO_VDDMAX,
};
...
struct omap_volt_data omap444x_vdd_iva_volt_data[] = {
...
struct omap_vp_param omap444x_iva_vp_data = {
	.on_volt		= OMAP4430_ON_VOLTAGE_UV,
	.onlp_volt		= OMAP4430_ONLP_VOLTAGE_UV,
	.ret_volt		= OMAP4430_RET_VOLTAGE_UV,
	.off_volt		= OMAP4430_OFF_VOLTAGE_UV,
	.vp_vddmin		= OMAP4430_VP_IVA_VLIMITTO_VDDMIN,
	.vp_vddmax		= OMAP4430_VP_IVA_VLIMITTO_VDDMAX,
};

#define OMAP4430_VDD_CORE_OPP50_UV		1025000
#define OMAP4430_VDD_CORE_OPP100_UV		1200000

struct omap_volt_data omap444x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP50_UV, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0xf4, 0x0c),
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100_UV, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16),
	VOLT_DATA_DEFINE(0, 0, 0, 0),
};

struct omap_vp_param omap444x_core_vp_data = {
	.on_volt		= OMAP4430_ON_VOLTAGE_UV,
	.onlp_volt		= OMAP4430_ONLP_VOLTAGE_UV,
	.ret_volt		= OMAP4430_RET_VOLTAGE_UV,
	.off_volt		= OMAP4430_OFF_VOLTAGE_UV,
	.vp_vddmin		= OMAP4430_VP_CORE_VLIMITTO_VDDMIN,
	.vp_vddmax		= OMAP4430_VP_CORE_VLIMITTO_VDDMAX,
};
...
/*
 * Structures containing OMAP4460 voltage supported and various
 * voltage dependent data for each VDD.
 */
#define OMAP4460_VP_MPU_VLIMITTO_VDDMIN	0xA
#define OMAP4460_VP_MPU_VLIMITTO_VDDMAX	0x39
#define OMAP4460_VP_IVA_VLIMITTO_VDDMIN	0xA
#define OMAP4460_VP_IVA_VLIMITTO_VDDMAX	0x2D
#define OMAP4460_VP_CORE_VLIMITTO_VDDMIN	0xA
#define OMAP4460_VP_CORE_VLIMITTO_VDDMAX	0x28

#define OMAP4460_ON_VOLTAGE_UV				1350000
#define OMAP4460_ONLP_VOLTAGE_UV			1350000
#define OMAP4460_RET_VOLTAGE_UV			837500
#define OMAP4460_OFF_VOLTAGE_UV			600000

#define OMAP4460_VDD_MPU_OPP50_UV		860000
#define OMAP4460_VDD_MPU_OPP100_UV		1010000
#define OMAP4460_VDD_MPU_OPPTURBO_UV		1170000
#define OMAP4460_VDD_MPU_OPPNITRO_UV		1350000
...
struct omap_vp_param omap446x_mpu_vp_data = {
	.on_volt		= OMAP4460_ON_VOLTAGE_UV,
	.onlp_volt		= OMAP4460_ONLP_VOLTAGE_UV,
	.ret_volt		= OMAP4460_RET_VOLTAGE_UV,
	.off_volt		= OMAP4460_OFF_VOLTAGE_UV,
...
#define OMAP4460_VDD_IVA_OPP100_UV		1010000
#define OMAP4460_VDD_IVA_OPPTURBO_UV		1170000
#define OMAP4460_VDD_IVA_OPPNITRO_UV		1230000
...
struct omap_vp_param omap446x_iva_vp_data = {
	...
	.ret_volt		= OMAP4460_RET_VOLTAGE_UV,
	.off_volt		= OMAP4460_OFF_VOLTAGE_UV,
	.vp_vddmin		= OMAP4460_VP_IVA_VLIMITTO_VDDMIN,
	.vp_vddmax		= OMAP4460_VP_IVA_VLIMITTO_VDDMAX,
};

#define OMAP4460_VDD_CORE_OPP50_UV		860000
#define OMAP4460_VDD_CORE_OPP100_UV		1010000
...
struct omap_vp_param omap446x_core_vp_data = {
	...
	.ret_volt		= OMAP4460_RET_VOLTAGE_UV,
	.off_volt		= OMAP4460_OFF_VOLTAGE_UV,
	.vp_vddmin		= OMAP4460_VP_CORE_VLIMITTO_VDDMIN,
	.vp_vddmax		= OMAP4460_VP_CORE_VLIMITTO_VDDMAX,
};
