	...
	unsigned long tx_flags, void *context)
{
	...
	for_each_sg(sgl, sg, sg_len, i) {
		...
		if (i == sg_len - 1)
			...
			/*
			 * Enable intermediate completion interrup for the set.
			 * Select early completion event. In this case the
			 * driver will be notified when the paRAM set is
			 * submitted to TC. This will allow more time to set up
			 * the next set of slots.
			 */
