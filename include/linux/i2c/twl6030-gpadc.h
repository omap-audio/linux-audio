...
#define TWL6025_GPADC_MAX_CHANNELS 19
/* Define this as the biggest of all chips using this driver */
#define GPADC_MAX_CHANNELS TWL6025_GPADC_MAX_CHANNELS
...
struct twl6030_gpadc_request {
	...
	int active;
	int result_pending;
	int rbuf[GPADC_MAX_CHANNELS];
	void (*func_cb)(struct twl6030_gpadc_request *req);
	struct twl6030_value buf[GPADC_MAX_CHANNELS];
};
...
#define TWL6025_GPADC_RTSELECT_LSB	0x04    /* 0x32 */
#define TWL6025_GPADC_RTSELECT_ISB	0x05
#define TWL6025_GPADC_RTSELECT_MSB	0x06

#define TWL6030_GPADC_CTRL_P1		0x05
#define TWL6030_GPADC_CTRL_P2		0x06

#define TWL6025_GPADC_GPSELECT_ISB	0x07
#define TWL6025_GPADC_CTRL_P1		0x08

#define TWL6025_RTCH0_LSB			0x09
#define TWL6025_RTCH0_MSB			0x0a
#define TWL6025_RTCH1_LSB			0x0b
#define TWL6025_RTCH1_MSB			0x0c
#define TWL6025_GPCH0_LSB			0x0d
#define TWL6025_GPCH0_MSB			0x0e
...
#define TWL6025_GPADC_RT_EOC_MASK		(1 << 4)
#define TWL6025_GPADC_SW_EOC_MASK		(1 << 5)
