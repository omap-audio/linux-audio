...
#define TAS2555_ASIX_SOURCE_REG			TAS2555_REG(0, 0, 42)
#define TAS2555_POWER_UP_FLAG_REG		TAS2555_REG(0, 0, 100)
#define TAS2555_HACK_GP02_REG			TAS2555_REG(0, 0, 122)
...
/*
 * Format registers:
 * B0P1R1 - TAS2555_ASI1_DAC_FORMAT_REG
 * B0P1R21 - TAS2555_ASI2_DAC_FORMAT_REG
 * B0P1R99 - TAS2555_ASIM_FORMAT_REG
 */
...
#define TAS2555_PLL_J_VAL_MASK			(0x7f << 0)
