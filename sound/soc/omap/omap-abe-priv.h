...
#define OMAP_ABE_AIF_ECHO		OMAP_ABE_WIDGET(43)
...
#define OMAP_ABE_MIXER_ECHO		OMAP_ABE_WIDGET(42)
...
#define OMAP_ABE_NUM_WIDGETS		(OMAP_ABE_AIF_ECHO - OMAP_ABE_AIF_TONES_DL)
#define OMAP_ABE_WIDGET_LAST		OMAP_ABE_AIF_ECHO
